...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(samLamV3Cpp(A, eta, sig, sigl, lam));
    return __result;
END_RCPP
}
// dmvnrm_arma
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(myfind(evec, e));
    return __result;
END_RCPP
}
// polyurncpp
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(polyurncpp(e, muA0, sigma0, A, sigma, sigmaInv, sigma0Inv, c));
    return __result;
END_RCPP
}
